...
export const STOCK_DETAILS: Record<string, string> = {
  ...
  QBTS: "D-Wave Quantum - ผู้นำระดับโลกด้านระบบคอมพิวเตอร์ควอนตัมชนิด Quantum Annealing เน้นใช้งานจริงในเชิงพาณิชย์ เช่น การเพิ่มประสิทธิภาพโลจิสติกส์และการจัดตารางงาน",
  RGTI: "Rigetti Computing - ผู้พัฒนาระบบคอมพิวเตอร์ควอนตัมแบบ Full-Stack ที่ใช้ชิปควอนตัมแบบตัวนำยิ่งยวด (Superconducting) พร้อมบริการเข้าถึงคลาวด์ควอนตัม",
